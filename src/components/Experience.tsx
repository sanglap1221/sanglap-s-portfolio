...
const Experience = () => {
  return (
    <section id="experience" className="py-16 border-t border-slate-200/70 dark:border-slate-800/80 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">Roles, impact, and proof of work.</p>
        </div>
        ...
        <div className="space-y-6">
          {experiences.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200/90 dark:border-slate-800 rounded-2xl p-6 sm:p-7 shadow-xs hover:border-blue-300 dark:hover:border-blue-700/60 transition-all"
              >
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white pt-1">{item.company}</h3>
                    <p className="text-sm font-medium text-blue-600 dark:text-blue-400">{item.role}</p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 self-start">
                    {item.certificateUrl && (
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900 text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-300 text-xs rounded-xl h-8"
                      >
                ...
                {/* Bullet points */}
                <ul className="mt-4 space-y-1.5 text-xs sm:text-sm text-slate-600 dark:text-slate-300">
                ...
                {item.tags && item.tags.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mt-5 pt-4 border-t border-slate-100 dark:border-slate-800">
